...
from keyboard_buttons import admin_keyboard,calculator_button,user_keyboard
...
async def is_admin(message:Message):
    await message.answer(text="Foydalanuvchi menu",reply_markup=admin_keyboard.user_bot)
...
@dp.message(Command("sifat"))
async def is_admin(message:Message):
    await message.answer(text="Biz haqimizda",reply_markup=admin_keyboard.calc_button)
